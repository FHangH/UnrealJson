...
namespace JsonDataHelper
{
    ...
    inline bool ValidateNodePath(const FString& NodePath, const TCHAR* FunctionName)
    {
        if (NodePath.IsEmpty())
        {
            FH_LOG_F(LogUnrealJsonRead, EF_LOG::Warning, TEXT("UAsync_ReadJson"), FunctionName, TEXT("NodePath is empty"));
            return false;
        }
        return true;
    }
    ...
    inline bool ValidateJsonArrayString(const FString& JsonArrayStr, const TCHAR* FunctionName)
    {
        ...
        {
            FH_LOG_F(LogUnrealJsonRead, EF_LOG::Warning, TEXT("UAsync_ReadJson"), FunctionName, TEXT("JsonArray is empty"));
            return false;
        }
        return true;
    }
    ...
    inline bool ValidateJsonValue(const TSharedPtr<FJsonValue>& JsonValue, const TCHAR* FunctionName)
    {
        ...
        {
            FH_LOG_F(LogUnrealJsonRead, EF_LOG::Warning, TEXT("UAsync_ReadJson"), FunctionName, TEXT("Failed to parse JsonArray Or JsonValue is Invalid"));
            return false;
        }
        return true;
    }
    ...
    inline bool ValidateJsonValueIsArray(const TSharedPtr<FJsonValue>& JsonValue, const TCHAR* FunctionName)
    {
        ...
        {
            FH_LOG_F(LogUnrealJsonRead, EF_LOG::Warning, TEXT("UAsync_ReadJson"), FunctionName, TEXT("JsonValue is not an array"));
            return false;
        }
        return true;
    }
    ...
    inline bool ValidateJsonArrayNotEmpty(const TSharedPtr<FJsonValue>& JsonValue, const TCHAR* FunctionName)
    {
        ...
        {
            FH_LOG_F(LogUnrealJsonRead, EF_LOG::Warning, TEXT("UAsync_ReadJson"), FunctionName, TEXT("JsonValue to array is empty"));
            return false;
        }
        return true;
    }
        ...
        const TCHAR* FunctionName)
    {
        ...
        if (const FJsonDataStruct* FoundData = ParsedDataMap.Find(NodePath))
        {
            ...
            FH_LOG_F(LogUnrealJsonRead, EF_LOG::Error, TEXT("UAsync_ReadJson"), FunctionName, 
                FString::Printf(TEXT("Node [ %s ] is not a %s, Node Type: [ %s ]"), 
                    *NodePath, Traits::GetTypeName(), *GetValueTypeName(FoundData->ValueType)));
            return;
        }

        FH_LOG_F(LogUnrealJsonRead, EF_LOG::Warning, TEXT("UAsync_ReadJson"), FunctionName, FString::Printf(TEXT("Node [ %s ] not found"), *NodePath));
    }
}
